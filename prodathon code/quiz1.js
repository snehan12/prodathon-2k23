...
const quizArray = [
    {
        id: "0",
        question: "Which programming language is known for its simplicity and readability and uses indentation to define code blocks?",
        options: ["python", "java", "ruby", "c++"],
        correct: "python",
    },
    {
        id: "1",
        question: "What is the most common file extension for a text document?",
        options: [".txt", ".html", ".php", ".text"],
        correct: ".txt",
    },
    {
        id: "2",
